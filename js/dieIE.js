...
//set text
var html;
html = "<strong>phpIPAM only works on newer browsers!</strong><br>Please use at least IE8, IE9 is recommended (if you have to use IE :/)<hr>You can get browsers here:";
html += "<ul>";
