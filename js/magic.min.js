...
$('a.discovery').click(function() {;showSpinner();$('a.discovery').attr("disabled", 'disabled');$.post('functions/scripts/discovery.php', function(data) {$('div.popup_w700').html(data);showPopup('popup_w700');hideSpinner();});return false;});
