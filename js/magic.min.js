...
function hidePopup3() {$('#popupOverlay').fadeOut('fast');$('.popup').fadeOut('fast');$('body').removeClass('stop-scrolling');$('.popup_w700').css("z-index", "100");hideSpinner();location.reload();}
