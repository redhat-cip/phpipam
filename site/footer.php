...
if (strlen(strstr($_SERVER['PHP_SELF'],"login"))>0) {
	$loginPrefix = "../";
} 
else {
	$loginPrefix = "";
...
print '	<td id="donate"  title="phpipam is free, open-source project.<br>If you like the software you can donate by clicking this button to support further development.">
...
">
<input type="image" src="'. $loginPrefix .'css/images/btn_donate_SM.gif" name="submit">
	</td>';	
