...
print '	<td id="donate" rel="tooltip" title="phpipam is free, open-source project.<br>If you like the software you can donate by clicking this button to support further development.">
