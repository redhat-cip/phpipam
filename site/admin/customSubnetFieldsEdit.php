...
<div class="pHeader"><?php print ucwords(_("$_POST[action]")); ?> <?php print _('custom subnet field'); ?></div>


<div class="pContent">

	<form id="editCustomSubnetFields">
	<table id="editCustomSubnetFields" class="table table-noborder">
