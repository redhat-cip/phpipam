...
<div class="pHeader"><?php print ucwords($_POST['action']); ?> <?php print _('custom VLAN field'); ?></div>
...
<div class="pFooter">
	...
	<button class="btn btn-small <?php if($_POST['action']=="delete") print "btn-danger" ?>" id="editcustomVLANSubmit"><i class="icon-gray <?php if($_POST['action']=="delete") print "icon-white" ?> icon-ok"></i> <?php print ucwords(_($_POST['action'])); ?></button>
