...
if($_POST['action'] == "delete") {
	...
	# length > 4 and < 12
	if( (strlen($_POST['name']) < 3) || (strlen($_POST['name']) > 24) ) 	{ $errors[] = 'Name must be between 4 and 24 characters!'; }
...
if(sizeof($errors) != 0) {
	...
	if(!updateCustomIPField($_POST)) 	{ print '<div class="alert alert-error">Failed to '. $_POST['action'] .' field!</div>';}
