...
if (!in_array("ldap", $availableExt)) { print '<div class="alert alert-error"><strong>Warning:</strong> '._('ldap extension not enabled in php').'!</div>'; }
...
<tr>
	...
	<td class="info"><?php print _('Enter domain controllers, separated by ; (default: dc1.domain.local;dc2.domain.local)'); ?>
	</td>
</tr>
